...
const HERO_IMAGE = "/images/contact-hero.webp";
...
function SweepCTA({
  ...
  const cls = `group/cta relative inline-flex items-center gap-2 overflow-hidden rounded-full border px-6 py-3 transition-colors duration-300 ${
    dark
      ? "border-[#fafaf7]/25 hover:border-[#FF6700]"
      : "border-[#0a0a0a]/20 hover:border-[#FF6700]"
  }`;
  ...
  const inner = (
    <>
      ...
      <span
        className={`relative font-['NeueMontreal'] text-[11px] sm:text-xs tracking-[0.18em] uppercase ${
          dark
            ? "text-[#fafaf7] group-hover/cta:text-[#0a0a0a]"
            : "text-[#0a0a0a]"
        }`}
      >
        {children}
      ...
      <LuArrowUpRight
        className={`relative w-3.5 h-3.5 transition-transform duration-300 group-hover/cta:rotate-45 ${
          dark
            ? "text-[#fafaf7] group-hover/cta:text-[#0a0a0a]"
            : "text-[#0a0a0a]"
        }`}
...
export default function ContactContent() {
  ...
  const validate = () => {
    ...
    if (!form.email.trim()) {
      next.email = "We'll need your email.";
    } else if (
    ...
    <>
      ...
      <section className="px-5 sm:px-10 md:px-20 pt-32 sm:pt-40 md:pt-48 pb-12 sm:pb-16">
        ...
        >
          ...
          >
            For tours and standard bookings, the app handles it in a minute.
            For managed offices, partnerships, press, or anything that needs a
            human, use the form below. We reply within 24 hours, every day
            except Sunday.
          </motion.p>
        </motion.div>
      </section>
      ...
      <section
        id="contact-form"
        className="px-5 sm:px-10 md:px-20 py-16 sm:py-24 md:py-28 border-t border-[#0a0a0a]/10"
      >
          ...
          <aside className="lg:col-span-5 lg:pl-8 lg:border-l border-[#0a0a0a]/10">
            ...
            >
              ...
              <motion.div variants={fadeUp}>
                <p className="font-['Founders_Grotesk'] text-lg text-[#0a0a0a]/45 mb-5">
                  Reach us directly
                </p>
              ...
              <motion.div variants={fadeUp}>
                ...
                <div className="flex items-start gap-4 p-4 rounded-2xl border border-[#0a0a0a]/10 bg-white">
                  <div className="w-11 h-11 rounded-xl bg-[#0a0a0a]/[0.04] flex items-center justify-center flex-shrink-0">
                    <LuClock
                      className="w-[18px] h-[18px] text-[#0a0a0a]/50"
                      strokeWidth={2}
                    />
                  </div>
                  ...
                  <div className="font-['NeueMontreal'] text-sm sm:text-base leading-relaxed">
                    ...
                    <p className="text-[#0a0a0a]/45 text-xs mt-1.5">
                      Closed on Sundays for the team to reset.
                    </p>
                  </div>
                </div>
              </motion.div>
              ...
              {/* ── SKIP THE FORM ───────────────────────────────────────
                  Clean white treatment to match the rest of the sidebar.
                  The orange left rule keeps this shortcut visibly distinct
                  without introducing another dark/patterned visual language.
              ---------------------------------------------------------------- */}
              <motion.div
                variants={fadeUp}
                className="
                  ...
                  border
                  border-[#0a0a0a]/10
                  shadow-[0_18px_45px_-26px_rgba(10,10,10,0.22)]
                "
              >
                <span
                  aria-hidden="true"
                ...
                <div className="relative pl-2">
                  <p className="font-['Founders_Grotesk'] text-base text-[#FF6700] mb-3">
                    Skip the form
                  </p>
      ...
      <section className="relative px-5 sm:px-10 md:px-20 py-20 sm:py-28 md:py-32 overflow-hidden border-t border-[#0a0a0a]/10">
        ...
        >
          <Heading
            lead="The best decisions are made"
            accent="in person."
          />
  ...
  return (
    <Link
      ...
      className="
        ...
        border
        border-[#0a0a0a]/10
        hover:border-[#FF6700]/40
        hover:shadow-[0_28px_60px_-30px_rgba(10,10,10,0.28)]
        transition-all
        duration-500
      "
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <span
          aria-hidden="true"
          className="absolute inset-0 bg-gradient-to-t from-[#0a0a0a]/30 via-transparent to-transparent"
        />
        ...
        <span
          className="
            ...
            text-xs
            text-[#0a0a0a]
            shadow-[0_6px_18px_-8px_rgba(10,10,10,0.5)]
          "
        >
          {loc.area}
        </span>
    ...
    <div>
      <div className="flex items-baseline justify-between mb-2.5">
        <label className="font-['Founders_Grotesk'] text-sm sm:text-base text-[#0a0a0a]/55">
          ...
          {required && (
            <span className="not-italic text-[#FF6700] ml-1">
              *
            </span>
          )}
        </label>
        ...
        {helper && (
          <span className="font-['NeueMontreal'] text-[11px] text-[#0a0a0a]/35">
            {helper}
          </span>
        )}
      </div>
      ...
      {error && (
        <p className="mt-2 font-['NeueMontreal'] text-xs text-[#CC5200]">
          {error}
        </p>
      )}
    </div>
...
function PillField({
  ...
  return (
    <div>
      <label className="block font-['Founders_Grotesk'] text-sm sm:text-base text-[#0a0a0a]/55 mb-3.5">
        {label}
      </label>
  ...
  return (
    <a
      ...
      className="
        ...
        bg-white
        overflow-hidden
        hover:border-[#FF6700]/45
        hover:shadow-[0_18px_40px_-24px_rgba(10,10,10,0.22)]
        transition-all
        duration-400
      "
    >
      ...
      <div className="w-11 h-11 rounded-xl bg-[#0a0a0a]/[0.04] flex items-center justify-center flex-shrink-0 group-hover:bg-[#FF6700]/12 transition-colors duration-300">
        <Icon
          className="w-[18px] h-[18px] text-[#0a0a0a]/55 group-hover:text-[#FF6700] transition-colors duration-300"
          strokeWidth={2}
        />
      </div>

      <div className="min-w-0 flex-1">
        <p className="font-['Founders_Grotesk'] text-sm text-[#0a0a0a]/45">
          {label}
        </p>

        <p className="font-['NeueMontreal'] text-[#0a0a0a] text-sm sm:text-[15px] font-medium truncate">
          {value}
        </p>
      </div>
...
/*
  Phone row:
  - No copy button.
  - Number remains on one line.
  - WhatsApp remains directly beside it.
  - Separate anchors are used so phone and WhatsApp remain independent actions.
*/
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="relative font-['NeueMontreal'] text-[13px] font-medium whitespace-nowrap">
          WhatsApp
        </span>
      </a>
    </div>
...
function SuccessState({ onReset }) {
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="absolute inset-x-0 top-0 h-[3px] bg-[#FF6700]"
      />
      ...
      <p className="font-['NeueMontreal'] text-[#0a0a0a]/70 text-base sm:text-lg leading-relaxed mb-6 max-w-[44ch]">
        Your message landed safely. Someone from the team will be in touch
        within 24 hours.
      </p>
